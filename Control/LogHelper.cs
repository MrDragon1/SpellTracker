...
namespace SpellTracker.Control
{
    public class Log
    {
        ...
        {
            log.Debug("  " + write + "。Error：" + ex.ToString());
        }
        #endregion
        ...
        {
            log.Info("  " + write + "。Error：" + ex.ToString());
        }
        #endregion
        ...
        {
            log.Warn("  " + write + "。Error：" + ex.ToString());
        }
        #endregion
        ...
        {
            log.Error("  " + write + "。Error：" + ex.ToString());
        }
        #endregion
        ...
        {
            log.Fatal("  " + write + "。Error：" + ex.ToString());
        }
        //#endregion
        ...
        //定义输出的日志内容
        public static string logMessage(string logMessage)
        {
